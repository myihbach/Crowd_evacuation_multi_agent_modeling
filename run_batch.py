...
fixed_params = dict(floor_plan_file="floor1.txt", human_count=human_count, fire_probability=0.8, visualise_vision=False, random_spawn=True, save_plots=True)
...
for i in range(1, runs + 1):
    ...
    plt.xlabel("Pourcentage des collaborateurs (%)", fontsize=14)
